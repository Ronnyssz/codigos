<?php
	...
	if(!empty($_POST))
	{
		...
		$activo = 0;
		$tipo_usuario = 2;
		$secret = '6LdF89waAAAAAEtpSYXBFRRaFVVkuhfzcDfF9u6N';
		...
		if(!isEmail($email))
		{
			$errors[] = "Direccion de correo invalidad";
		}
				...
				<div class="panel panel-info">
					...
					<div class="panel-body" >
						...
						<form id="signupform" class="form-horizontal" role="form" action="<?php $_SERVER['PHP_SELF'] ?>" method="POST" autocomplete="off">
							...
							<div class="g-recaptcha col-md-9" data-sitekey="6LdF89waAAAAAPaudVZqaOdXgD1HIDMzJT015KhE"></div>
